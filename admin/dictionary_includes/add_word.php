...
if (isset($_POST['create'])) {
    ...
    $query = "INSERT INTO dictionary (word_title, word_pronounce, word_meaning, word_explanation, word_examples) VALUES (?, ?, ?, ?, ?) ";
    $save_stmt = mysqli_prepare($connection, $query);
    mysqli_stmt_bind_param($save_stmt, 'sssss', $word_title, $word_pronounce, $word_meaning, $word_explanation, $word_examples);
